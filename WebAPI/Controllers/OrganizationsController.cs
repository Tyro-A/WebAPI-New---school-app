...
namespace WebAPI.Controllers
{
    ...
    public class OrganizationsController : ControllerBase
    {
        ...
        public OrganizationsController(AuthenticationContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Organizations/5/students
        [HttpGet("{id}/students")]
        public async Task<ActionResult<IEnumerable<Student>>> GetOrganizationStudents(int id)
        {

            var students = await _context.Students.Where(s => s.OrganizationId == id).ToListAsync();
